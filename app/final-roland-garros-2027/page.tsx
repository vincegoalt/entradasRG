...
export const metadata: Metadata = {
  ...
  description: 'Todo sobre la final de Roland Garros 2027: la final femenina el 5 de junio y la final masculina el 6 de junio en Philippe-Chatrier. Horarios, entradas, cómo ver por TV y guía completa.',
  keywords: [
    'final roland garros 2027',
    'final masculina roland garros 2027',
    'final femenina roland garros 2027',
    'cuando es la final de roland garros',
    'finales roland garros 2027',
    'semifinales roland garros 2027'
  ],
  openGraph: {
    title: 'Final Roland Garros 2027: Fechas, Horarios y Entradas',
...
const faqs = [
  {
    ...
    answer: 'La final femenina de Roland Garros 2027 se disputará el sábado 5 de junio de 2027 y la final masculina el domingo 6 de junio de 2027, ambas en la pista Philippe-Chatrier del Stade Roland Garros en París.'
  },
  {
    question: '¿A qué hora es la final de Roland Garros 2027?',
  ...
  {
    question: '¿Cómo ver la final de Roland Garros 2027 por TV?',
  ...
  {
    question: '¿Cuándo son las semifinales de Roland Garros 2027?',
    answer: 'Las semifinales masculinas se juegan el viernes 4 de junio y las semifinales femeninas el jueves 3 de junio de 2027, ambas en la pista Philippe-Chatrier.'
  },
  {
  ...
  {
    question: '¿Quiénes son los favoritos para la final de Roland Garros 2027?',
...
export default function FinalRolandGarros2027Page() {
  return (
    <>
      <SportsEventSchema
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="rounded-xl border border-[#ead5cd] bg-gradient-to-r from-orange-50/50 to-[#fcf9f8] p-6 shadow-sm mb-10">
                <p className="text-[#1d110c] text-base leading-relaxed">
                  <strong>La final femenina de Roland Garros 2027 se juega el sábado 5 de junio</strong> y la <strong>final masculina el domingo 6 de junio</strong>, ambas en la pista Philippe-Chatrier (15,225 espectadores) a partir de las 15:00. Las entradas para la final van desde 150 EUR hasta más de 540 EUR y se asignan por <Link href="/entradas-roland-garros-2027" className="text-primary font-semibold hover:underline">lotería oficial</Link>.
                </p>
              </div>
              ...
              <section className="mb-12">
                ...
                <div className="bg-gradient-to-r from-orange-50 to-white border border-[#ead5cd] rounded-xl p-6 mb-6">
                  ...
                  <p className="text-sm text-gray-600 mt-4">
                    Los paquetes están disponibles a través de proveedores autorizados y plataformas como <a href="https://goaltickets.com/es/products/chatrier-french-open-tickets-2027-may-23-sunday-day-session" target="_blank" rel="noopener" className="text-primary font-semibold hover:underline">GoalTickets</a>. Reserva con anticipación ya que se agotan rápidamente.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  ...
                  >
                    ...
                    <p className="text-sm text-[#a15d45]">
                      Todas las fechas y horarios del torneo Roland Garros 2027.
                    </p>
                  </Link>
                </div>
              </section>
