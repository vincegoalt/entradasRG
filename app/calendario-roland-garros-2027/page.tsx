...
export const metadata: Metadata = {
  title: 'Fechas Roland Garros 2027: Cuándo Es, Calendario y Horarios',
...
export default function CalendarioPage() {
  const faqs = [
    {
      question: '¿Cuándo se celebra Roland Garros 2027?',
      answer: 'Roland Garros 2027 se celebrará del 23 de mayo al 6 de junio de 2027. El torneo dura dos semanas completas, con las rondas de clasificación comenzando unos días antes del inicio oficial del cuadro principal.'
    },
    {
      question: '¿Qué días son las finales de Roland Garros 2027?',
      answer: 'La final femenina se disputará el sábado 5 de junio de 2027, mientras que la final masculina tendrá lugar el domingo 6 de junio de 2027. Las finales de dobles se juegan durante el fin de semana del torneo.'
    },
    {
    ...
    {
      question: '¿Cuándo es la final de Roland Garros 2027?',
      answer: 'La final femenina de Roland Garros 2027 se disputa el sábado 5 de junio y la final masculina el domingo 6 de junio de 2027, ambas en la pista Philippe-Chatrier. Las finales de dobles también se juegan ese fin de semana.'
    },
    {
      question: '¿Cuándo se juega Roland Garros 2027?',
      answer: 'Roland Garros 2027 se juega del 23 de mayo al 6 de junio de 2027. La clasificación comienza el 17 de mayo. Los partidos del cuadro principal empiezan a las 11:00 en pistas principales y las sesiones nocturnas a las 20:00 en Philippe-Chatrier.'
    }
  ]
  ...
  return (
    <>
      <SportsEventSchema
        ...
        endDate="2027-06-06"
        description="Calendario completo del torneo Roland Garros 2027 con fechas de cada ronda y horarios"
      />
      <FAQSchema faqs={faqs} />
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div className="rounded-xl border border-[#ead5cd] bg-gradient-to-r from-orange-50/50 to-[#fcf9f8] p-6 shadow-sm mb-12">
          <p className="text-[#1d110c] text-base leading-relaxed">
            <strong>Roland Garros 2027 se celebra del 23 de mayo al 6 de junio de 2027.</strong> La final femenina es el sábado 5 de junio y la final masculina el domingo 6 de junio, ambas en la pista Philippe-Chatrier. Los partidos comienzan a las 11:00 en pistas principales y las sesiones nocturnas a las 20:00. Puedes <Link href="/entradas-roland-garros-2027" className="text-primary font-semibold hover:underline">comprar entradas para Roland Garros 2027</Link> desde 35 EUR.
          </p>
        </div>
            ...
            <section id="finales">
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-[#ead5cd]">
                <p className="text-[#a15d45] mb-6">
                  El fin de semana de las finales es el clímax del torneo, donde se coronan los campeones en la legendaria pista Philippe-Chatrier. Consulta nuestra <Link href="/final-roland-garros-2027" className="text-primary font-semibold hover:underline">guía completa de la final de Roland Garros 2027</Link> o cómo <Link href="/entradas-roland-garros-2027" className="text-primary font-semibold hover:underline">comprar entradas</Link>.
                </p>
