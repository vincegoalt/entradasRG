...
export default function HorariosPorRondaPage() {
  return (
    <>
      ...
      <PageHero
        title="Horarios por Ronda Roland Garros 2027"
        subtitle="Horarios detallados de cada ronda del torneo"
        image="/images/heroes/clay-court.jpg"
        badge={{ icon: 'schedule', text: 'Horarios Detallados' }}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none">
              ...
              <h2 className="text-3xl font-bold mb-6 text-gray-900 mt-12">Primera Ronda (23-25 de mayo)</h2>
              ...
              <h2 className="text-3xl font-bold mb-6 text-gray-900 mt-12">Segunda y Tercera Ronda (26-29 de mayo)</h2>
              ...
              <div className="bg-orange-50 border-l-4 border-orange-600 p-6 mb-8 rounded-r-lg">
                ...
                <div className="mt-4 space-y-2">
                  <p className="text-gray-800"><strong>Lunes 30 de mayo:</strong> 8 partidos (4 hombres, 4 mujeres)</p>
                  <p className="text-gray-800"><strong>Martes 31 de mayo:</strong> 8 partidos (4 hombres, 4 mujeres)</p>
                </div>
              </div>
              ...
              <h2 className="text-3xl font-bold mb-6 text-gray-900 mt-12">Cuartos de Final (1-2 de junio)</h2>
              ...
              <div className="bg-gray-50 rounded-lg p-6 mb-8">
                ...
                <div className="space-y-4">
                  <div>
                    <p className="font-semibold text-gray-900 mb-2">Martes 1 de junio - Cuartos de Final Masculinos</p>
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 mb-2">Miércoles 2 de junio - Cuartos de Final Femeninos</p>
                    <ul className="space-y-1 text-gray-700 ml-4">
              ...
              <h2 className="text-3xl font-bold mb-6 text-gray-900 mt-12">Semifinales (3-4 de junio)</h2>
              ...
              <div className="bg-white border-2 border-orange-200 rounded-lg p-6 mb-8">
                ...
                <div className="space-y-4">
                  <div className="bg-orange-50 p-4 rounded">
                    <p className="font-semibold text-gray-900 mb-2">Jueves 3 de junio - Semifinales Femeninas</p>
                  ...
                  <div className="bg-orange-50 p-4 rounded">
                    <p className="font-semibold text-gray-900 mb-2">Viernes 4 de junio - Semifinales Masculinas</p>
                    <p className="text-gray-700 mb-1"><strong>Primera semifinal:</strong> 12:00 horas aproximadamente</p>
                    <p className="text-gray-700"><strong>Segunda semifinal:</strong> Tras finalizar la primera (generalmente 15:00-16:00 h)</p>
                    <p className="text-gray-600 mt-2 text-sm">
              ...
              <h2 className="text-3xl font-bold mb-6 text-gray-900 mt-12">Finales (5-6 de junio)</h2>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div className="bg-gradient-to-br from-orange-50 to-white border-2 border-orange-300 rounded-lg p-6">
                  ...
                  <p className="text-gray-900 text-lg mb-2"><strong>Sábado 5 de junio de 2027</strong></p>
                ...
                <div className="bg-gradient-to-br from-orange-50 to-white border-2 border-orange-300 rounded-lg p-6">
                  ...
                  <p className="text-gray-900 text-lg mb-2"><strong>Domingo 6 de junio de 2027</strong></p>
                  <p className="text-gray-700 mb-4"><strong>Horario:</strong> 15:00 horas (aproximadamente)</p>
                  <p className="text-gray-600 mb-3">
                  ...
                  <p className="text-gray-600 text-sm">
                    ...
                    marcando el final oficial de Roland Garros 2027.
                  </p>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <Link
                href="/calendario-roland-garros-2027/fechas-importantes"
                className="text-orange-600 hover:text-orange-700 font-medium flex items-center"
              >
                <span className="mr-2">→</span>
