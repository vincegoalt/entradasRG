...
export const metadata: Metadata = {
  title: 'Fechas Importantes Roland Garros 2027 | Calendario Detallado',
...
export default function FechasImportantesPage() {
  return (
    <>
      ...
      <PageHero
        title="Fechas Importantes Roland Garros 2027"
        subtitle="Todas las fechas clave del torneo"
        image="/images/heroes/clay-court.jpg"
        badge={{ icon: 'event', text: 'Fechas Clave 2027' }}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed mb-8">
                Conocer las fechas importantes de Roland Garros 2027 es fundamental para planificar tu visita
              ...
              <h2 className="text-3xl font-bold mb-6 text-gray-900 mt-12">Resumen de Fechas Clave 2027</h2>

              <div className="bg-orange-50 border-l-4 border-orange-600 p-6 mb-8 rounded-r-lg">
                <ul className="space-y-2 text-gray-800">
                  <li><strong>Venta de entradas (lotería finales):</strong> Febrero-Marzo 2027 — <a href="https://goaltickets.com/es/products/chatrier-french-open-tickets-2027-may-23-sunday-day-session" target="_blank" rel="noopener" className="text-orange-600 hover:underline font-medium">ver disponibilidad actual</a></li>
                  <li><strong>Clasificaciones:</strong> 18-22 de mayo de 2027</li>
                  <li><strong>Inicio del cuadro principal:</strong> Domingo 23 de mayo de 2027</li>
                  <li><strong>Día del Niño:</strong> Sábado 22 de mayo de 2027</li>
                  ...
                  <li><strong>Final masculina:</strong> Domingo 6 de junio de 2027</li>
                </ul>
              </div>

              <h2 className="text-3xl font-bold mb-6 text-gray-900 mt-12">Rondas de Clasificación (18-22 de mayo)</h2>
              ...
              <div className="bg-white border-2 border-gray-200 rounded-lg p-6 mb-8">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start">
                    ...
                    <span><strong>Primera ronda de clasificación:</strong> 18-19 de mayo</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-orange-600 mr-2 font-bold">•</span>
                    <span><strong>Segunda ronda de clasificación:</strong> 20-21 de mayo</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-orange-600 mr-2 font-bold">•</span>
                    <span><strong>Ronda final de clasificación:</strong> 22 de mayo</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-orange-600 mr-2 font-bold">•</span>
              ...
              <h2 className="text-3xl font-bold mb-6 text-gray-900 mt-12">Primera Semana del Torneo (23-29 de mayo)</h2>
              ...
              <h3 className="text-2xl font-bold mb-4 text-gray-900">Primera Ronda (23-25 de mayo)</h3>
              <div className="bg-gray-50 rounded-lg p-6 mb-6">
                <p className="text-gray-700 mb-4">
                  El domingo 23 de mayo marca el inicio oficial del cuadro principal con la primera ronda del
              ...
              <h3 className="text-2xl font-bold mb-4 text-gray-900">Segunda Ronda (26-27 de mayo)</h3>
              <div className="bg-gray-50 rounded-lg p-6 mb-6">
                <p className="text-gray-700 mb-4">
              ...
              <h3 className="text-2xl font-bold mb-4 text-gray-900">Tercera Ronda (28-29 de mayo)</h3>
              <div className="bg-gray-50 rounded-lg p-6 mb-6">
                <p className="text-gray-700 mb-4">
              ...
              <h3 className="text-2xl font-bold mb-4 text-gray-900">Cuartos de Final (1-2 de junio)</h3>
              <div className="bg-gray-50 rounded-lg p-6 mb-6">
                <p className="text-gray-700 mb-4">
              ...
              <h3 className="text-2xl font-bold mb-4 text-gray-900">Semifinales (3-4 de junio)</h3>
              <div className="bg-gray-50 rounded-lg p-6 mb-6">
                <p className="text-gray-700 mb-4">
              ...
              <h3 className="text-2xl font-bold mb-4 text-gray-900">Finales (5-6 de junio)</h3>
              <div className="bg-orange-50 border-l-4 border-orange-600 p-6 mb-6 rounded-r-lg">
                <p className="text-gray-700 mb-4">
                  ...
                  batida. La final femenina el sábado 5 de junio y la final masculina el domingo 6 de junio son los
                ...
                <p className="text-gray-700 mb-4">
                  <strong>Final Femenina - Sábado 5 de junio:</strong> Tradicionalmente comienza alrededor de las
                  15:00 horas. La ceremonia de premiación sigue inmediatamente después del partido.
                </p>
                <p className="text-gray-700 mb-4">
                  <strong>Final Masculina - Domingo 6 de junio:</strong> Generalmente programada para las 15:00 horas.
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div className="bg-white border-2 border-orange-200 rounded-lg p-6">
                  ...
                  <p className="text-gray-700 mb-2"><strong>Fecha:</strong> Sábado 22 de mayo de 2027</p>
                ...
                <div className="bg-white border-2 border-orange-200 rounded-lg p-6">
                  ...
                  <p className="text-gray-700 mb-2"><strong>Fechas:</strong> 5-6 de junio de 2027</p>
                  <p className="text-gray-600">
              ...
              <div className="space-y-4 mb-8">
                <div className="border-l-4 border-orange-500 pl-6 py-2">
                  ...
                  <p className="text-gray-700">
                    Elige la primera semana (23-29 de mayo), especialmente los primeros días. Podrás ver muchos
                ...
                <div className="border-l-4 border-orange-500 pl-6 py-2">
                  ...
                  <p className="text-gray-700">
                    Los cuartos de final (1-2 de junio) son la opción ideal. Tenis de máximo nivel con solo
                ...
                <div className="border-l-4 border-orange-500 pl-6 py-2">
                  ...
                  <p className="text-gray-700">
                    Las finales del fin de semana (5-6 de junio) ofrecen la experiencia más memorable y prestigiosa,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <Link
                href="/calendario-roland-garros-2027/horarios-por-ronda"
                className="text-orange-600 hover:text-orange-700 font-medium flex items-center"
              >
                <span className="mr-2">→</span>
                Horarios por Ronda
              ...
              <Link
                href="/calendario-roland-garros-2027/orden-de-juego"
                className="text-orange-600 hover:text-orange-700 font-medium flex items-center"
              >
                <span className="mr-2">→</span>
