...
const homeFaqs = [
  {
    ...
    answer: 'Roland Garros 2027 se celebra del 23 de mayo al 6 de junio de 2027 en el Stade Roland Garros de París. Las rondas de clasificación comienzan el 17 de mayo. La final femenina es el 5 de junio y la final masculina el 6 de junio.'
  },
  {
    question: '¿Cuándo empieza Roland Garros 2027?',
    answer: 'El cuadro principal de Roland Garros 2027 comienza el domingo 23 de mayo de 2027. Las rondas de clasificación arrancan el lunes 17 de mayo. Los partidos en pistas principales empiezan a las 11:00 y las sesiones nocturnas en Philippe-Chatrier a las 20:00.'
  },
  {
  ...
  return (
    <>
      <SportsEventSchema
        ...
        endDate="2027-06-06"
        description="French Open 2027 - Grand Slam de tenis en tierra batida"
      />
      ...
      <section className="relative min-h-[520px] sm:min-h-[560px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 sm:gap-8 px-4 text-center max-w-3xl mx-auto">
          ...
          <Countdown targetDate="2027-05-23T11:00:00+02:00" />
      ...
      <div className="mx-auto max-w-[960px] px-4 sm:px-6 lg:px-8">
        ...
        <section className="w-full py-8">
          <div className="rounded-xl border border-[#ead5cd] bg-white p-6 shadow-sm">
            <p className="text-[#1d110c] text-base leading-relaxed">
              <strong>Roland Garros 2027</strong> se celebra del <strong>23 de mayo al 6 de junio</strong> en el Stade Roland Garros de París, sobre tierra batida. Las entradas están disponibles <strong>desde 35 EUR</strong> (ground pass). La pista central Philippe-Chatrier tiene capacidad para <strong>15,225 espectadores</strong> y techo retráctil. El torneo incluye <strong>128 jugadores</strong> en cada cuadro individual durante <strong>2 semanas</strong> de competición. Consulta las <Link href="/calendario-roland-garros-2027" className="text-primary font-semibold hover:underline">fechas de Roland Garros 2027</Link>, cómo <Link href="/entradas-roland-garros-2027" className="text-primary font-semibold hover:underline">comprar entradas para Roland Garros 2027</Link>, o la guía de la <Link href="/final-roland-garros-2027" className="text-primary font-semibold hover:underline">final de Roland Garros 2027</Link>.
            </p>
          </div>
        </section>
        ...
        <section className="w-full py-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <Link href="/calendario-roland-garros-2027" className="group card-hover rounded-xl border border-[#ead5cd] bg-white p-6 flex flex-col gap-4">
            ...
            <Link href="/entradas-roland-garros-2027" className="group card-hover rounded-xl border-2 border-primary/30 bg-orange-50/50 p-6 flex flex-col gap-4">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
              <div className="flex-1 text-center md:text-left">
                ...
                <h2 className="text-white text-2xl sm:text-3xl font-bold mb-3">
                  Asegura tus Entradas para Roland Garros 2027
                </h2>
        ...
        <section className="w-full py-10 pb-16">
          <div className="rounded-2xl bg-gradient-to-r from-primary to-orange-400 p-8 sm:p-10 text-center text-white shadow-xl">
            ...
            <p className="mb-6 max-w-lg mx-auto text-white/90">
              Recibe las últimas noticias, consejos y ofertas exclusivas para Roland Garros 2027 directamente en tu correo.
            </p>
