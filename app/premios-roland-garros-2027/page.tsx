...
export const metadata: Metadata = {
  ...
  description: 'Descubre cuánto gana el campeón de Roland Garros 2027, el prize money por ronda, comparativa con otros Grand Slams, impuestos y datos curiosos sobre los premios.',
  keywords: [
    'premios roland garros 2027',
    'prize money roland garros',
    'cuanto gana el campeon de roland garros',
    'premios roland garros por ronda',
    'dinero roland garros 2027',
    'premio campeon roland garros',
    'prize money grand slam 2027',
...
const faqs = [
  {
    ...
    answer: 'El campeón individual de Roland Garros 2027 se lleva aproximadamente 2.400.000 EUR en premios. Es el mayor premio del torneo, aunque tras impuestos franceses (~20-30% para no residentes) el importe neto se reduce a unos 1.700.000-1.900.000 EUR.'
  },
  {
...
export default function PremiosRolandGarros2027Page() {
  return (
    <>
      <FAQSchema faqs={faqs} />
      ...
      <div className="min-h-screen bg-[#fcf9f8]">
        <PageHero
          title="Premios Roland Garros 2027"
          ...
          badge={{ icon: 'emoji_events', text: 'Prize Money 2027' }}
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="rounded-xl border border-[#ead5cd] bg-gradient-to-r from-orange-50/50 to-[#fcf9f8] p-6 shadow-sm mb-10">
                <p className="text-[#1d110c] text-base leading-relaxed">
                  <strong>El campeón individual de Roland Garros 2027 se llevará aproximadamente 2.400.000 EUR</strong>, con un prize money total estimado de <strong>~53 millones de euros</strong>. Incluso un jugador eliminado en primera ronda cobra unos 55.000 EUR. Desde 2006, hombres y mujeres reciben premios idénticos.
                </p>
              </div>
              ...
              <section id="premios-por-ronda" className="mb-12">
                <h2 className="text-3xl font-bold mb-6 text-[#1d110c]">
                  Prize Money por Ronda en Roland Garros 2027
                </h2>
                ...
                <p className="text-[#a15d45] text-sm">
                  * Los importes son estimaciones basadas en la progresión histórica. Los premios oficiales de 2027 se confirmarán semanas antes del torneo.
                </p>
              </section>
              ...
              <section className="mt-12">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  ...
                  >
                    ...
                    <p className="text-sm text-[#a15d45]">
                      Resuelve todas tus dudas sobre Roland Garros 2027.
                    </p>
                  </Link>
                </div>
              </section>
