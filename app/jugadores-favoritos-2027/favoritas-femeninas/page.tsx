...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Favoritas Femeninas Roland Garros 2027: Análisis Completo',
    description: 'Análisis profundo de las principales candidatas femeninas para el título de Roland Garros 2027',
    type: 'article',
  },
  alternates: {
    canonical: 'https://www.entradasrolandgarros.com/jugadores-favoritos-2027/favoritas-femeninas/',
  },
}
...
export default function FavoritasFemeninasPage() {
  return (
    <>
      <PageHero
        title="Favoritas Femeninas Roland Garros 2027"
        subtitle="Las jugadoras con más opciones de conquistar París"
        image="/images/heroes/tennis-action.jpg"
        badge={{ icon: 'sports_tennis', text: 'Cuadro Femenino' }}
      ...
      <div className="bg-white border-b border-[#ead5cd] py-4">
        <div className="container mx-auto px-4">
          <nav className="text-[#a15d45] text-sm">
            <Link href="/jugadores-favoritos-2027" className="hover:text-primary">Jugadores Favoritos</Link>
            <span className="mx-2">/</span>
            <span>Favoritas Femeninas</span>
          </nav>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <p className="text-lg leading-relaxed text-gray-700 mb-6">
              El tenis femenino en 2027 presenta uno de los panoramas más emocionantes y competitivos de la historia
            ...
            <p className="text-lg leading-relaxed text-gray-700 mb-6">
              La tierra batida ha producido algunas de las finales más memorables del tenis femenino, y 2027 promete
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-md p-8 mb-8 border-l-4 border-pink-600">
              ...
              <div className="bg-pink-50 p-4 rounded-lg">
                <p className="text-gray-700">
                  <strong>Pronóstico:</strong> Swiatek es la clara favorita para Roland Garros 2027. Su dominio
            ...
            <div className="bg-white rounded-lg shadow-md p-8 mb-8 border-l-4 border-blue-600">
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <p className="text-gray-700">
                  <strong>Pronóstico:</strong> Gauff tiene el potencial de ganar Roland Garros 2027. Su juego
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              ...
              <p className="text-gray-700 mb-4">
                Varias jugadoras jóvenes que estarán alcanzando su madurez tenística en 2027 podrían estar listas
            ...
            <div className="bg-gradient-to-r from-orange-50 to-red-50 border border-orange-300 rounded-lg p-8">
              <p className="text-lg text-gray-700 mb-4">
                El torneo femenino de Roland Garros 2027 presenta un panorama fascinante con múltiples candidatas
              ...
              <p className="text-lg text-gray-700">
                ...
                determinar quién levantará la Copa Suzanne Lenglen en 2027.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <Link
                href="/jugadores-favoritos-2027/favoritos-masculinos"
              ...
              >
                <h3 className="font-bold mb-2 text-gray-900">Calendario 2027</h3>
