...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.entradasrolandgarros.com/jugadores-favoritos-2027/',
  },
}
  ...
  return (
    <>
      <div className="min-h-screen bg-[#fcf9f8]">
        {/* Hero Section */}
        <PageHero
          title="Jugadores Favoritos Roland Garros 2027"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto space-y-6">
              <p className="text-lg leading-relaxed text-[#1d110c]">
                Roland Garros 2027 promete ser una edición histórica del torneo más prestigioso en tierra batida.
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-[#a15d45] mb-4">
                  Análisis detallado de los principales candidatos al título masculino en Roland Garros 2027
                </p>
              ...
              <Link
                href="/jugadores-favoritos-2027/favoritas-femeninas"
                className="card-hover bg-white p-6 rounded-xl shadow-sm border border-[#ead5cd]"
              >
                <span className="material-symbols-outlined text-primary block mb-3" style={{fontSize: '32px'}}>
                  emoji_events
            ...
            <div className="max-w-4xl mx-auto space-y-12">
              ...
              <article>
                <h2 className="text-3xl font-bold mb-6 text-[#1d110c]">
                  El Panorama del Tenis en Tierra Batida para 2027
                </h2>
              ...
              <article>
                ...
                <p className="text-lg leading-relaxed text-[#1d110c] mb-4">
                  Aunque miramos hacia Roland Garros 2027, es imposible hablar de este torneo sin mencionar a Rafael
                ...
                <p className="text-lg leading-relaxed text-[#1d110c]">
                  ...
                  determinación que pocos atletas poseen. Los favoritos de 2027 buscarán emular no solo su técnica,
        ...
        <section className="py-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl font-bold mb-6 text-[#1d110c] text-center">
              Explora Más Sobre Roland Garros 2027
            </h2>
            <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
              ...
              >
                ...
                <p className="text-[#a15d45] text-sm">Fechas exactas de todas las rondas del torneo 2027</p>
              </Link>
              <Link
        ...
        <section className="py-16 bg-gradient-to-br from-[#1d110c] via-[#2a1a12] to-[#1d110c]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-bold mb-4 text-white">
              ¿Listo para Seguir a tus Favoritos en Roland Garros 2027?
            </h2>
