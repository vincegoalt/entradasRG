...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Favoritos Masculinos Roland Garros 2027: Análisis Completo',
    description: 'Análisis profundo de los principales candidatos masculinos para el título de Roland Garros 2027',
    type: 'article',
  },
  alternates: {
...
export default function FavoritosMasculinosPage() {
  return (
    <>
      <PageHero
        title="Favoritos Masculinos Roland Garros 2027"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <p className="text-lg leading-relaxed text-gray-700 mb-6">
              El cuadro masculino de Roland Garros 2027 presenta una competición fascinante con una mezcla perfecta
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              ...
              <p className="text-gray-700 mb-4">
                Varios jugadores jóvenes que estarán entre los 18 y 22 años en 2027 podrían estar listos para dar
            ...
            <div className="bg-gradient-to-r from-orange-50 to-red-50 border border-orange-300 rounded-lg p-8">
              <p className="text-lg text-gray-700 mb-4">
                El torneo masculino de Roland Garros 2027 promete ser uno de los más abiertos y competitivos de
