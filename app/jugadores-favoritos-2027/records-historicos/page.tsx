...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.entradasrolandgarros.com/jugadores-favoritos-2027/records-historicos/',
  },
}
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-orange-50 to-red-50 border-l-4 border-orange-600 p-8 rounded-lg">
              ...
              <p className="text-lg text-gray-700">
                Mirando hacia Roland Garros 2027 y más allá, estos records históricos proporcionan el contexto
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-6 text-gray-900">Explora Más Sobre Roland Garros 2027</h2>
            <div className="grid md:grid-cols-3 gap-4">
              ...
              >
                ...
                <p className="text-sm text-gray-600">Candidatos al título 2027</p>
              </Link>
              <Link
              ...
              >
                ...
                <p className="text-sm text-gray-600">Candidatas al título 2027</p>
              </Link>
              <Link
