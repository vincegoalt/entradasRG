...
export default function FechasImportantesPage() {
  return (
    <>
      ...
      <PageHero
        title="Fechas Importantes Roland Garros 2026"
        subtitle="Todas las fechas clave del torneo"
        image="/images/heroes/clay-court.jpg"
        badge={{ icon: 'event', text: 'Fechas Clave 2026' }}
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-orange-50 border-l-4 border-orange-600 p-6 mb-8 rounded-r-lg">
                <ul className="space-y-2 text-gray-800">
                  <li><strong>Venta de entradas (lotería finales):</strong> Febrero-Marzo 2026 — <a href="https://goaltickets.com/es/collections/entradas-roland-garros-2026" target="_blank" rel="noopener" className="text-orange-600 hover:underline font-medium">ver disponibilidad actual</a></li>
