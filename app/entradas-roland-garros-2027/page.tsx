...
const faqs = [
  {
    ...
    answer: 'Las entradas oficiales para Roland Garros 2027 saldrán a la venta a principios de 2027, típicamente en febrero o marzo. El proceso incluye un sistema de lotería para las entradas más demandadas de las finales y semifinales.'
  },
  {
  ...
  return (
    <>
      <SportsEventSchema
        ...
        endDate="2027-06-06"
        description="Entradas para Roland Garros 2027 - French Open"
      />
      <FAQSchema faqs={faqs} />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto rounded-xl border border-[#ead5cd] bg-gradient-to-r from-orange-50/50 to-[#fcf9f8] p-6 shadow-sm">
              <p className="text-[#1d110c] text-base leading-relaxed">
                <strong>Las entradas para Roland Garros 2027 van desde 35 EUR</strong> (ground pass primera semana) hasta más de 500 EUR (finales Philippe-Chatrier). La venta oficial se realiza exclusivamente en rolandgarros.com, con un sistema de lotería para semifinales y finales que abre en febrero-marzo 2027. El ground pass da acceso a todas las pistas exteriores excepto las tres principales. Consulta también las <Link href="/entradas-final-roland-garros" className="text-primary font-semibold hover:underline">entradas para la final</Link>, el <Link href="/calendario-roland-garros-2027" className="text-primary font-semibold hover:underline">calendario completo</Link> y el <Link href="/estadio-roland-garros/mapa-instalaciones" className="text-primary font-semibold hover:underline">mapa de instalaciones</Link>.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
              <Link
                href="/entradas-roland-garros-2027/tipos-de-entradas"
              ...
              <Link
                href="/entradas-roland-garros-2027/ground-pass"
                className="bg-white p-6 rounded-xl shadow-sm border border-[#ead5cd] hover:shadow-md transition-shadow text-center"
              >
                <span className="material-symbols-outlined text-primary block mb-3" style={{fontSize: '32px'}}>
                  badge
            ...
            <div className="max-w-4xl mx-auto space-y-12">
              ...
              <section>
                <p className="text-lg text-[#1d110c] leading-relaxed mb-6">
                  Conseguir entradas para Roland Garros 2027 requiere planificación y conocimiento del sistema de venta oficial.
              ...
              <section>
                ...
                <h3 className="text-2xl font-bold mb-4 text-[#1d110c]">Calendario de Venta de Entradas 2027</h3>
              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <Link
                    ...
                    className="block bg-white border border-[#ead5cd] rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow"
                  >
                    <h3 className="text-xl font-bold mb-2 text-[#1d110c]">Calendario 2027</h3>
                    <p className="text-[#1d110c] mb-3">
                  ...
                  <Link
                    ...
                    className="block bg-white border border-[#ead5cd] rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow"
                  >
                    <h3 className="text-xl font-bold mb-2 text-[#1d110c]">Final Roland Garros 2027</h3>
                    <p className="text-[#1d110c] mb-3">
