  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        <PageHero
          title="Precios Entradas Roland Garros 2027"
              ...
              <section className="mb-12 max-w-4xl mx-auto">
                ...
                <div className="bg-orange-50 border-l-4 border-orange-500 p-6 mb-8">
                  ...
                  <p className="text-gray-700">
                    ...
                    Los precios oficiales para 2027 se anunciarán cuando se abra la venta de entradas (típicamente en
                    febrero-marzo 2027). Los precios reales pueden variar ligeramente, pero estas estimaciones te dan
              ...
              <section className="mb-12 max-w-4xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    <p className="text-gray-700 mb-3">
                      Volver a la guía completa de entradas Roland Garros 2027.
                    </p>
                    <span className="text-orange-600 font-semibold">Leer más →</span>
                  </Link>
                </div>
