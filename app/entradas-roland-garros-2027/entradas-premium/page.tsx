...
export default function EntradasPremiumPage() {
  return (
    <>
      ...
      <PageHero
        title="Entradas Premium Roland Garros 2027"
        ...
        primaryCta={{ text: 'Comprar Entradas Premium', href: 'https://goaltickets.com/es/products/chatrier-french-open-tickets-2027-may-23-sunday-day-session', icon: 'confirmation_number', external: true }}
      />
        ...
        <section className="bg-white py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
              Experiencias Premium en Roland Garros 2027
            </h2>
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              ...
              y cómo reservar para el torneo de 2027.
            </p>
          </div>
        </section>
        ...
        <section className="bg-white py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-8">
              ...
              de los diferentes niveles de entradas premium disponibles en Roland Garros 2027.
            </p>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              ...
              <Link
                ...
                className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 hover:shadow-md transition-shadow"
              >
                <h3 className="font-bold text-gray-900 mb-2">Entradas 2027</h3>
                <p className="text-gray-600 text-sm">Toda la información sobre entradas para Roland Garros 2027.</p>
              </Link>
              <Link
