...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'ground pass roland garros 2027',
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        <PageHero
          title="Ground Pass Roland Garros 2027"
          subtitle="Todo sobre el ground pass: acceso, precio y ventajas"
          image="/images/heroes/tennis-crowd.jpg"
          badge={{ icon: 'badge', text: 'Desde 35 EUR' }}
            ...
            <div className="max-w-4xl mx-auto prose prose-lg">
              ...
              <section className="mb-12">
                <SessionsTable
                  columns={['grounds']}
                  onlyWithColumns
                  title="Ground Pass por día — Roland Garros 2027"
                  subtitle="El Ground Pass está disponible del 23 al 30 de mayo (primera semana). Compra el pase de jardines para cada jornada en GoalTickets."
                />
              </section>
              ...
              <section className="mb-12">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <Link
                    ...
                    className="block bg-orange-50 border border-orange-200 rounded-lg p-6 hover:shadow-lg transition-shadow"
                  >
                    <h3 className="text-xl font-bold mb-2 text-gray-900">Calendario 2027</h3>
                    <p className="text-gray-700 mb-3">
